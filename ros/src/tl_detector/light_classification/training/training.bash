...
python ./models/research/object_detection/export_inference_graph.py --pipeline_config_path=training.config --trained_checkpoint_prefix=training_intermediate/model.ckpt-5000 --output_directory=training_results
